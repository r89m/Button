/*
 * MPR121Button example. This shows a basic example of how to receive proximity events from electrodes on an MPR121 Capactive Touch IC
 */ 
...
MPR121ProximityButton2 button1 = MPR121ProximityButton2(touchSensor, 6);
MPR121ProximityButton2 button2 = MPR121ProximityButton2(touchSensor, 2);
MPR121ProximityButton2 button3 = MPR121ProximityButton2(touchSensor, 3);
...
void setup(){
  ...
  // Setup the proxmity button's sensitivity
  button1.setThresholds(40, 3);
  button2.setThresholds(10, 5);
  button3.setThresholds(10, 5);
	
  
  button1.setRefreshDelay(50);
...
void onButtonHeld(Button& btn, uint16_t duration, uint16_t repeatCount){
  ...
  Serial.print(" has been held for ");
